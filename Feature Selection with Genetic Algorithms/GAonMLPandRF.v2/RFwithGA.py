...
def main(n_gen=10000, pop_size=20):    #population arrumar
...
#criar um arquivo txt com as acuracias ao longo das geraçoes 
#para apos fazer um grafico com as acuracias que mudaram ao longo do tempo
